...
const AI_API_BASE_URL = import.meta.env.VITE_AI_API_BASE_URL || 'https://icoopmk-api.trinova.it.com'
const API_BASE_URL = import.meta.env.VITE_API_URL || import.meta.env.VITE_API_BASE_URL || 'https://icoopmk-api.trinova.it.com'
